...
//SELECT * FROM `wp_posts` WHERE `post_title` = 'Venezuela'
 $sql1 = "SELECT wp_posts.post_title,wp_postmeta.post_id FROM wp_postmeta,wp_posts WHERE  `meta_key` = 'state_meta_box_country' AND `meta_value` = $state_posts AND wp_postmeta.post_id = wp_posts.ID
";
//var_dump($sql1);
